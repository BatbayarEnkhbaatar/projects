...
df = pd.read_csv("params_02_01.csv", sep=",", index_col=0)
...
while one_time_max < 5413:
    try:
        proxy_info = get_proxy.proxy_generator3(Username, Password, EndPoint)
        ...
        num_of_fail +=1
        print("This is blocked, rotating Proxy", "Failed attempt :", num_of_fail)
